        ...
        <form>
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="password">Equipment Quantity</label>
                        <input
                                type="text"
                                id="equipQty"
                                class="form-control"
                    ...
                    <div class="form-group">
                        <label for="age">Equipment Type</label>
                          <validation-provider rules="required" v-slot="{ errors }">
                            <select name="types" class="form-control" v-model="equipment.equipmentTypeName" :class="{'error-message': errors[0]}">
                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                    <button
                            class="btn btn-primary" @click.prevent="postEquipment()">Submit!
                    </button>
                    <button
                            class="btn btn-danger ml-2" @click="cancel">Cancel!
                    </button>
                </div>
        </form>
    </div>
